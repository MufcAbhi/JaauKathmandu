<?php
$title = "Add International Flights";
...
if (isset($_POST['btnSave'])) {
	...
	$status=$flight->SaveFlightInternational();
	...
	echo '<div style="margin-top: 25px; height: 80px; margin-bottom: -30px;" align="center" class="alert alert-success alert-dismissable">
            ...
            International Flight is <strong>successfully </strong> added!
            </div>';
	}
}
?>
...
<head>
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add International Flights</h1>
